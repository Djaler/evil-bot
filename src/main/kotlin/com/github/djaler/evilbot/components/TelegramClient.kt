...
class TelegramClient(
    ...
    suspend fun sendDiceTo(chatId: ChatId, animationType: DiceAnimationType): ContentMessage<DiceContent> {
        return requestsExecutor.sendDice(chatId = chatId, animationType = animationType)
    }
